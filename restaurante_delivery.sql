...
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `restaurante_delivery` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `restaurante_delivery`.`endereco` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `restaurante_delivery`.`carrinho` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `restaurante_delivery`.`nivel` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `restaurante_delivery`.`usuario` ;
...
CREATE TABLE IF NOT EXISTS `restaurante_delivery`.`usuario` (
  ...
  INDEX `fk_usuario_nivel1_idx` (`nivel_id_nivel` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_usuario_nivel1`
    ...
    REFERENCES `restaurante_delivery`.`nivel` (`id_nivel`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `restaurante_delivery`.`fornecedor` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `restaurante_delivery`.`produto_categoria` ;

CREATE TABLE IF NOT EXISTS `restaurante_delivery`.`produto_categoria` (
  `id_produto_tipo` INT NOT NULL AUTO_INCREMENT,
  `nome_produto_categoria` VARCHAR(255) NOT NULL,
  PRIMARY KEY (`id_produto_tipo`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `restaurante_delivery`.`promocao_produto` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `restaurante_delivery`.`item_carrinho` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `restaurante_delivery`.`produto` ;
...
CREATE TABLE IF NOT EXISTS `restaurante_delivery`.`produto` (
  ...
  `tipo_id_produto_tipo` INT NOT NULL,
  `produto_categoria_id_produto_tipo` INT NOT NULL,
  `promocao_produto_id_promocao_produto` INT NOT NULL,
  `item_carrinho_id_item_carrinho` INT NOT NULL,
  PRIMARY KEY (`id_produto`, `item_carrinho_id_item_carrinho`),
  INDEX `fk_produto_fornecedor1_idx` (`fornecedor_id_fornecedor` ASC) VISIBLE,
  INDEX `fk_produto_tipo1_idx` (`tipo_id_produto_tipo` ASC) VISIBLE,
  INDEX `fk_produto_produto_categoria1_idx` (`produto_categoria_id_produto_tipo` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_produto_tipo1`
    FOREIGN KEY (`tipo_id_produto_tipo`)
    REFERENCES `restaurante_delivery`.`produto_tipo` (`id_produto_tipo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_produto_produto_categoria1`
    FOREIGN KEY (`produto_categoria_id_produto_tipo`)
    REFERENCES `restaurante_delivery`.`produto_categoria` (`id_produto_tipo`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `restaurante_delivery`.`promocao` ;
...
CREATE TABLE IF NOT EXISTS `restaurante_delivery`.`promocao` (
  ...
  INDEX `fk_promocao_promocao_produto1_idx` (`promocao_produto_id_promocao_produto` ASC) VISIBLE,
  CONSTRAINT `fk_promocao_promocao_produto1`
    FOREIGN KEY (`promocao_produto_id_promocao_produto`)
    REFERENCES `restaurante_delivery`.`promocao_produto` (`id_promocao_produto`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `restaurante_delivery`.`item_carrinho_has_carrinho`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `restaurante_delivery`.`item_carrinho_has_carrinho` ;

CREATE TABLE IF NOT EXISTS `restaurante_delivery`.`item_carrinho_has_carrinho` (
  `item_carrinho_id_item_carrinho` INT NOT NULL,
  `carrinho_id_carrinho` INT NOT NULL,
  PRIMARY KEY (`item_carrinho_id_item_carrinho`, `carrinho_id_carrinho`),
  INDEX `fk_item_carrinho_has_carrinho_carrinho1_idx` (`carrinho_id_carrinho` ASC) VISIBLE,
  INDEX `fk_item_carrinho_has_carrinho_item_carrinho1_idx` (`item_carrinho_id_item_carrinho` ASC) VISIBLE,
  CONSTRAINT `fk_item_carrinho_has_carrinho_item_carrinho1`
    FOREIGN KEY (`item_carrinho_id_item_carrinho`)
    REFERENCES `restaurante_delivery`.`item_carrinho` (`id_item_carrinho`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_item_carrinho_has_carrinho_carrinho1`
    FOREIGN KEY (`carrinho_id_carrinho`)
    REFERENCES `restaurante_delivery`.`carrinho` (`id_carrinho`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `restaurante_delivery`.`pedido` ;
...
CREATE TABLE IF NOT EXISTS `restaurante_delivery`.`pedido` (
  ...
  INDEX `fk_pedido_carrinho1_idx` (`carrinho_id_carrinho` ASC) VISIBLE,
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `restaurante_delivery`.`cargo` ;
...
-- -----------------------------------------------------
DROP TABLE IF EXISTS `restaurante_delivery`.`funcionario` ;
